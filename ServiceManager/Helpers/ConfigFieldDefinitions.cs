...
namespace ServiceManager.Helpers
{
    public static class ConfigFieldDefinitions
    {
        public static readonly List<ConfigField> AllFields = new()
        {
            ...
            new ConfigField { Key = "AppSettings:OwnMarginPercent", Label = "Własna marża (%)", Group = "Inne ustawienia", FieldType = ConfigFieldType.Int },
            new ConfigField { Key = "AppSettings:AllegroMarginUnder5PLN", Label = "Marża allegro poniżej 5 PLN", Group = "Inne ustawienia", FieldType = ConfigFieldType.Int },
            new ConfigField { Key = "AppSettings:AllegroMarginBetween5and1000PLNPercent", Label = "Marża allegro 5-1000 PLN (%)", Group = "Inne ustawienia", FieldType = ConfigFieldType.Int },
            new ConfigField { Key = "AppSettings:AllegroMarginMoreThan1000PLN", Label = "Marża allegro powyżej 1000 PLN", Group = "Inne ustawienia", FieldType = ConfigFieldType.Int },
            new ConfigField { Key = "AppSettings:AddPLNToBulkyProducts", Label = "Dodatek PLN do towarów gabarytowych", Group = "Inne ustawienia", FieldType = ConfigFieldType.Int },
            new ConfigField { Key = "AppSettings:AddPLNToCustomProducts", Label = "Dodatek PLN do towarów niestandardowych", Group = "Inne ustawienia", FieldType = ConfigFieldType.Int },
