...
namespace Allegro.JSAGRO2.Gaska.ProductsService.Helpers
{
    public static class OfferFactory
    {
            ...
            string? offerProductId = null)
        {
            ...
            {
                ProductSet = BuildProductSet(product, quantity, allegroSettings, includeProductParameters, offerProductId),
                Stock = new Stock
                {
                    Available = available,
